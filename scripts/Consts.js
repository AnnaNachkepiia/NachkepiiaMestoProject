...
export const popupOpenAddButttonElement = document.querySelector(".profile__add-button");
export const popupEditCloseButtonElement =
    document.querySelector(".popup__close_edit");
export const popupAddCloseButtonElement = document.querySelector(".popup__close_add");
export const popupImgCloseButtonElement = document.querySelector(".popup__close_img");
...
export const popupSubmitButtonAdd = popupAddElement.querySelector('.popup__submit_type_create');
...
export const nameInput = popupFormElement.querySelector(".popup__edit-form_type_name");
export const jobInput = popupFormElement.querySelector(".popup__edit-form_type_about");
...
export const editProfileValidator = new FormValidator(formObj, popupFormElement);
export const addCardValidator = new FormValidator(formObj, popupAddFormElement);